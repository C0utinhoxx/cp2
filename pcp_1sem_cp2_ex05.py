...
valemp = float(input("Digite o valor desejado do empréstimo: "))
while valemp <= 0:
...
if aprovado == 1:
    ...
    print(f'Total de juros pagos: R$ {jurospagos:.2f}')
else:
    if idade <= 18 and rendamen * 20 < valemp:
        print('Crédito não aprovado: cliente deve ter mais de 18 anos e o valor do empréstimo não pode ser maior que 20 vezes a renda mensal.')
    elif idade <= 18:
        print('Crédito não aprovado: cliente deve ter mais de 18 anos.')
    else:
        print('Crédito não aprovado: valor do empréstimo é maior que 20 vezes a renda mensal do cliente.')