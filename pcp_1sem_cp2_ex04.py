...
while cargo < 1 or cargo > 4:
    cargo = int(input('O código do cargo deve ser entre 1 e 4 (1-Gerente, 2-Analista, 3-Assistente, 4-Estagiário), digite novamente: '))
...
descfalt = calcular_descontos_faltas(salar, falt)
